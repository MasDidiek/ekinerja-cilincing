                                        ...
                                        <table class="table" id="customerTable">
                                          ...
                                          <?php 
                                                  ...
                                                  foreach ($data_pegawai as $pegawai){
                                                      ...
                                                      echo' <tr class=" fs-5">
                                                              <td>'.$no.'</td>
                                                              <td>  <a href="'.base_url().'admin/penilaian_kinerja/nilai_perilaku/'.$id_pegawai.'"> '.$nama.'</a>   </td>
                                                              <td>'.$jabatan.'</td>
                                                              <td class="text-center fw-bold">  '.$totalPoin.'   </td>
                                                              <td>
                                                                <a href="'.base_url().'admin/penilaian_kinerja/generate_nilai_perilaku/'.$id_pegawai.'" class="btn text-success">
                                                                    <i class="uil-refresh"></i> Generate
                                                                </a>
