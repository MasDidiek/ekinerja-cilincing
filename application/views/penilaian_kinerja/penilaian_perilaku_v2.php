    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Penilaian Perilaku</h5>
                </div>
                            ...
                            <table class="w-full whitespace-nowrap" id="customerTable">
                                <thead class="bg-slate-100 dark:bg-zink-600">
                                    ...
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="no">No</th>
                                        ...
                                        <th class="sort text-right  px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500" data-sort="nilai">Nilai Perilaku</th>
                                ...
                                <?php 
                                        ...
                                        foreach ($data_pegawai as $pegawai){
                                            ...
                                            echo' <tr class=" fs-2">
                                                    ...
                                                    <a href="'.base_url().'admin/penilaian_kinerja/nilai_perilaku/'.$id_pegawai.'"> '.$nama.'</a>
                                                   </td>
                                                   
                                                    <td class=" text-left px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 jabatan">'.$jabatan.'</td>
                                                    <td class="text-right px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 nilai">
                                                   '.$totalPoin.'
                                                    </td>
