...
<body>
            ...
            ?>
                    <table class="bg-white mb-2">
                          
                          <tr>
                            <td class="p-2 text-left  border-slate-100 dark:border-zink-500">Tgl Pengajuan : </td>
                            <td class="fw-bold"><?php echo format_full($tgl_pengajuan);?> </td>
                        ...
                        $(".btn-acc").click(function(){
                           ...
                           $.ajax({
                                      ...
                                      success:function(msg){
                                        $("#detail_cuti").html(msg);


                                          //   $(".btn-acc").html(msg);
                                          //   $(".btn-acc").addClass("bg-slate-100 text-slate-300");
