                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="text-center">
                            <img src="<?php echo base_url();?>assets/images/success_register.jpeg" alt="File not found Image">
                            <h3 class="mt-4">Registrasi Berhasil</h3>
                            <p class="text-muted">Silahkan melakukan login untuk mengakses aplikasi ekinerja</p>
                            <a href="<?php echo base_url();?>login/login_page" class="btn btn-info">LOGIN</a>

                            <div class="row mt-5">
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        <i class="dripicons-jewel bg-primary maintenance-icon text-white mb-2"></i>
                                        <h5 class="text-uppercase">Apa itu ekinerja ?</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        ...
                                        <h5 class="text-uppercase">Bagaimana cara menggunakan?</h5>
