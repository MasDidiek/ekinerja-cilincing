                            ...
                            <div class="col-xxl-12">
                                <div class="card w-100">
                                    <div class="card-body p-2">
                                         ...
                                         <a href="<?php echo base_url();?>dashboard/dashboard_pengajuan_dl" class="btn btn-info">Pengajuan Dinas Luar (<?php echo count($pengajuanDL);?>)</a>
                                         <a href="<?php echo base_url();?>dashboard/dashboard_pengajuan_izin" class="btn btn-light">Pengajuan Izin</a>
                                         <a href="<?php echo base_url();?>dashboard/dashboard_pengajuan_sakit" class="btn btn-light">Pengajuan Sakit</a>
                                    </div>
                                </div>
                            </div>
