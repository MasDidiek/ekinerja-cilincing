                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body fs-5">
                                            ...
                                            Selamat Datang, Anda login sebagai  <strong> Kepala Puskesmas Cilincing</strong> <br>
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-warning">Menunggu Persetujuan</small> <br>
                                             <a href="<?php echo base_url();?>dashboard/pengajuan_cuti_pending/kapus" class="btn btn-sm text-info btn-light">Lihat</a>
