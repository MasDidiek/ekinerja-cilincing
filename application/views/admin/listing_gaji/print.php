...
<?php
     $periode_bulan = $this->input->get('bulan'); 
     $periode_tahun = $this->input->get('tahun'); 
    ...
    <div style="clear:both"></div>
       ...
       <table>
            <tr>
                ...
                <td  width="20">:</td>
                <td> <strong> GAJI PEGAWAI NON PNS PUSAT KESEHATAN MASYARAKAT CILINCING	</strong> </td>
            </tr>
            <tr>
                <td>Unit	</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td> 001 Pembayaran Gaji Non PNS </td>
            </tr>
        ...
        <br> <br>
         ...
         <table border="1" cellspacing="5" cellpadding="5" class="table">
            ...
            <?php 
                ...
                $ukpd = $this->Pegawai_model->getNamaPuskesmasByNama($nama);
