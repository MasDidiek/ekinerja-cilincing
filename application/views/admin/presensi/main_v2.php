                ...
                <div class="card">
                    <div class="card-body">
                        <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-12">
                              ...
                              <div class="xl:col-span-3">
                                    <div class="relative">
                                        <input type="text" name="nama_pegawai" id="keyword" class="ltr:pl-8 rtl:pr-8 search form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="<?php echo  $keyword;?>" placeholder="Search for ..." value autocomplete="off">
                                              ...
                                              foreach ($pegawai as $peg){
                                                ...
                                                #print_array($peg);
                                                          ...
                                                          if (!empty($dataRekap)) {
                                                              ...
                                                              if($status==1){
                                                                $flag_rekap = '<i data-lucide="check-check" class="size-4 flex items-center justify-center text-green-500 "></i>';
                                                              }else{
                                                                $flag_rekap = '<i data-lucide="check" class="size-4 flex items-center justify-center text-orange-500 "></i>';
                                                              }
        
                                                          }else{
                                                            $flag_rekap = '<i data-lucide="minus" class="size-3"></i>';
                                                          }
                                                         ...
                                                         // flex items-center justify-center text-green-500 bg-green-100 rounded-md size-8 dark:bg-green-500/20 shrink-0
                                                          ...
                                                          echo ' <tr class="*:px-3.5 *:py-2.5 *:border-y *:border-slate-200 *:dark:border-zink-500">
                                                                     <td>'.$flag_rekap.'</td>
                                                                    <td>  <a href="#!"  data-modal-target="largeModal" id="'.$id_pegawai.'"  class="info-rekap transition-all duration-200 ease-linear"> '.word_limiter($nama,2).'</a></td>';
                        ...
                        <div class="flex flex-col items-center gap-4 px-4 mt-4 md:flex-row" id="pagination-element">
                            <div class="grow">
                                <p class="text-slate-500 dark:text-zink-200">Showing <b class="showing"><?php echo ($page+1) ;?></b> to <b class="showing"><?php echo $numPage ;?></b> of <b class="total-records"><?php echo $total_rows;?></b> Results</p>
                            </div>
