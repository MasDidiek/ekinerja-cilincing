                            ...
                            <table class="w-full whitespace-nowrap" id="customerTable">
                                <thead class="bg-slate-100 dark:bg-zink-600">
                                    <tr>
                                        ...
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="nip">PIN</th>
										<th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="nip">Tanggal</th>
										 <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="Shift">Shift</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="nama_pegawai">Masuk</th>
             
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="jabatan">Pulang</th>
                                    </tr>
                                </thead>
										 ...
										 $no = 1;
                                            ...
                                            foreach ($datalist as $list ) {
                                                    ...
                                                    echo ' <tr> 
                                                                ...
                                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 id" style="display:none;"><a href="javascript:void(0);" class="fw-medium link-primary id">'.$id.'</a></td>	
                                                               
                                                                <td class="text-center px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">'.$no.'</td>
                                                               
                                                                 <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 nrk" style="display:none;">'.$list->pin.'</td>
                                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 nip">'.$pin.'</td>
                                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">'.$tanggal.'</td>
                                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 nama_pegawai">'.$shift.' </td>
                                                            
                                                                
                                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">'.$masuk.'</td>
                                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">'.$pulang.'</td>
...
function deleteUser(id_absen){
        $.ajax({
                type: 'POST',
                url: '<?php echo base_url();?>admin/presensi/delete_absensi_detail',
