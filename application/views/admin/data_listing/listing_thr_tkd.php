                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <a href="<?= base_url('admin/data_listing/thr/tkd'); ?>" class="btn btn-white">THR TKD</a>
                                    <a href="<?= base_url('admin/data_listing/thr/gaji'); ?>" class="btn btn-white ">THR GAJI</a>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-xxl-12col-lg-12">
                                <div class="card widget-flat">
                                    <div class="card-body text-left">
                                        <h4>Data Listing TKD Non PNS</h4>
                                        <br>
                                        ...
                                        <div class="row mt-2 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                       ...
                                                       <a class="btn btn-success float-end ms-1" href="<?php echo base_url();?>admin/listing_tkd/update_capaian/<?php echo $periode;?>"  ><i class="uil-refresh"></i> Update Capaian</a>
                                                    
                                                       <!-- Secondary -->
                                                       <div class="dropdown btn-group float-end">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-animated">
                                                                <a class="dropdown-item"href="<?php echo base_url();?>admin/listing_tkd/view_daftar_ttd/tkd" ><i class="uil-file-alt"></i> Lihat TTD SPJ</a>
                                                                 <a class="dropdown-item" data-bs-toggle="modal" style="cursor: pointer;" data-bs-target="#import-modal"><i class="uil-download-alt"></i> Import File</a>
                                                                <a class="dropdown-item" href="<?php echo base_url();?>admin/listing_tkd/update_capaian/<?php echo $periode;?>"  ><i class="uil-refresh"></i> Update Capaian</a>
                                                                <a class="dropdown-item" href="<?php echo base_url();?>admin/listing_tkd/update_listing_tkd"><i class="uil-history-alt"></i> Update Listing</a> 
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="<?php echo base_url();?>admin/listing_tkd/create_listing" onclick="return confirm('Apakah anda ingin membuat listing TKD baru?');"><i class="uil-edit"></i> Create Listing TKD</a>
                                                            </div>
                                                        </div>
                                                         ...
                                                         $total_thp = 0;
                                                          ...
                                                          foreach ($listing_tkd as $peg){
                                                              ...
                                                              echo' <tr>
                                                                      ...
                                                                      <td>0</td>
                                                                      <td class="text-center"> <strong>'.rupiah($peg->total).'</strong></td>
                                                                      <td class="text-center">'.$peg->no_rekening.'</td>
                                                                         ...
                                                                         <a href="'.base_url().'admin/listing_tkd/detailTKD/'.$peg->id.'"  class="text-info"> 
                  ...
                  <div class="modal-dialog">
                      ...
                      <?php
                           // echo form_open_multipart(base_url() . 'admin/import_data/import_file');
                            echo form_open_multipart(base_url() . 'admin/import_data/preview');?>
                          ...
                          <div class="modal-body">
                                      ...
                                      <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" id="customRadio3" value="bpjs" name="jns_file" class="form-check-input">
                                                <label class="form-check-label" for="customRadio3">BPJS</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" id="customRadio4" value="bpjs_tk" name="jns_file" class="form-check-input">
                                                <label class="form-check-label" for="customRadio4">BPJS TK</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" id="customRadio4" value="pajak" name="jns_file" class="form-check-input">
                                                <label class="form-check-label" for="customRadio4">Pajak</label>
                                            </div>
