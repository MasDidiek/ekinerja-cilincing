                                              ...
                                              <?php 
                                                  ...
                                                  foreach ($pegawai as $peg){
                                                      ...
                                                      echo' <tr>
                                                                  ...
                                                                  <td><a href="'.base_url().'admin/pegawai/detail_pegawai_pjlp/'.$id_pegawai.'">'.$peg->nama.'</a></td>
                                                                  <td>'.$peg->jabatan.' </td>
                                                                  <td>'.$peg->lokasi_kerja.' </td>
                                                                  <td><a href="'.base_url().'admin/absensi_pjlp/index/'.$id_pegawai.'" class="btn btn-sm btn-info">Lihat Absensi</a></td>
