                                                         ...
                                                         $total_thp = 0;
                                                          ...
                                                          foreach ($listing_tkd as $peg){
                                                               ...
                                                               // $masa_kerja = $this->Pegawai_model->getMasaKerja($id_pegawai);
                                                                ...
                                                                $masaKerja = str_replace("tahun", "-", $masa_kerja);
                                                                $masaKerja = str_replace("bulan", "", $masaKerja);


                                                                $bruto = $peg->bruto;

                                                                $npwp = $peg->npwp;
                                                            // if($npwp=='745806380042000' || $npwp == '642775639407000'){
                                                            //     $denda  = ($bruto*25)/100;
                                                            //     $bruto  = $bruto-$denda;
                                                            // }
                                                             ...
                                                             $frmt_capaian = str_replace(".",",", $capaian);
                                                              ...
                                                              echo' <tr>
                                                                      <td class="text-center ">'.$no.'</td>
                                                                       <td class="text-center ">'.$masaKerja.'</td>
                                                                      ...
                                                                      <td class="text-center">'.rupiah($peg->bpjs_tk).'</td>
