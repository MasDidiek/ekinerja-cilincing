                            ...
                            <div class="col-xxl-12col-lg-12">
                                <div class="card widget-flat">
                                    <div class="card-body text-left">
                                        ...
                                        <div class="row mt-2 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <a href="<?php echo base_url();?>laporan/view_daftar_ttd_gaji13" class="btn btn-success me-2 float-end" ><i class="uil-file-alt"></i> Lihat TTD SPJ</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable-buttons" class="table table-sm  w-100">
                                                         ...
                                                         $total_thp = 0;
                                                          ...
                                                          $totalGaji13 = $totalGaji13+$total;
                                                              ...
                                                              echo' <tr>
                                                                      ...
                                                                      <td class="text-center">'.rupiah($peg->netto).'</td>
