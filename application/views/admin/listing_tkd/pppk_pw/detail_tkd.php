                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                                    ...
                                    $jenis_pegawai = $this->uri->segment(4);
                        ...
                        //print_array($detail_tkd);
                                   $detail_pegawai = $this->Laporan_model->getDataDetailPegawai($detail_tkd->nip);
                                         ...
                                         <div class="card-body border-top p-2">
                                           <h5>Perhitungan Tunjangan Kinerja</h5>
                                            ...
                                            <ul>
                                                ...
                                                <li class="text-danger"> Potongan Absensi :  <span class="float-end fw-bold">Rp. <?php echo rupiah($pot_absen);?></span></li>
                                                <li>  Bruto (TKD Pokok - Potongan Absensi) :  <span class="float-end fw-bold">Rp. <?php echo rupiah($bruto);?></span> </li>
                                            </ul>
                                           <br>
                                          ...
                                          <ul>
                                                ...
                                                <li>THT (Tunjangan Hari Tua) <span class="float-end fw-bold">Rp. <?php echo rupiah($tht);?></span></li>
                                          </ul>
                               ...
                               <!-- Modal Pemotongan Tunjangan -->
                                <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <form id="formPemotongan" action="<?php echo base_url();?>admin/listing_tkd/update_data_tkd?jns_pegawai=<?php echo $jenis_pegawai;?>" method="post">
                                            <div class="modal-body">
                                            <!-- Hidden id_rekap_tkd -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                     <div class="mb-3">
                                                        <label for="jumlah" class="form-label">Bruto</label>
                                                        <input type="text" class="form-control" id="bruto" value="<?php echo $bruto;?>" name="bruto" required>
                                                    </div>
                                                 </div>
                                                 <div class="col-md-4">
                                                     <div class="mb-3">
                                                        <label for="jumlah" class="form-label">Potongan Absen</label>
                                                        <input type="text" class="form-control" id="pot_absen" value="<?php echo $pot_absen;?>" name="pot_absen" required>
                                                    </div>
                                                 </div>
                                            </div>
                                             <div class="row">
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                  ...
                                                  <div class="col-md-4">
                                                     <div class="mb-3">
                                                        <label for="jumlah" class="form-label">THT</label>
                                                        <input type="text" class="form-control" id="tht" name="tht" value="<?php echo $tht;?>" required>
                                                    </div>
                                                 </div>
                                                  ...
                                                  <div class="col-md-12">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="jumlah" class="form-label">Total Penerimaan</label>
                                                                <input type="text" class="form-control" id="thp" name="thp" value="<?php echo $thp;?>" required>
                                                            </div>
