                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body p-4">
                                    ...
                                    <form method="post" action="<?php echo base_url();?>admin/gaji/update_data_bpjs_tk">
                                        <button type="button" class="btn btn-warning  btn-circle float-end ms-2"   data-bs-toggle="modal" data-bs-target="#import-modal" data-bs-whatever="@mdo">
                                            <i class="fa-solid fa-download"></i>&nbsp; Import Data BPJS
                                        </button>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($pegawai as $peg) {
                                                        ...
                                                        echo ' <tr>
                                                                  ...
                                                                  <td class="text-end"> ' . $bpjs_kes . '  </td>
                                                                  <td class="text-end"> <input type="number" name="bpjs_tk[]" value="' . $bpjs_tk . '"> </td>
                                                                  <td class="text-end"> ' . $pph21 . '</td>
                         ...
                         <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                     <?php
                                    echo form_open_multipart(base_url() . 'admin/gaji/import_bpjs');
                                    ...
                                    echo '
                                      ...
                                      <br>
                                       ...
                                       <input type="radio" name="jns" required value="1"> BPJS Kesehatan <br>
                                       <input type="radio" name="jns" required value="2"> BPJS TK <br> <br>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    echo '
                                      ...
                                      <input type="hidden" name="jns" required value="3">
                                      <button type="submit" class="btn btn-info" id="clickme">
                                        <i class="fa fa-external-link-square"></i> &nbsp; Import
                                      </button>';
