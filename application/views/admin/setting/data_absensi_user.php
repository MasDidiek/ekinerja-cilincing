                                          ...
                                          <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          <form action="<?php echo base_url();?>admin/mesin/insert_user/<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5);?>" method="post">
                                                    ...
                                                    for ($i=0; $i < count($list_user) ; $i++) { 
                                                        ...
                                                        if ($pin !='') {
                                                            ...
                                                            <td  class="text-center">
                                                             <a href="'.base_url().'admin/mesin/detail_user/'.$pin.'/'.$nama_url.'/'.$detail_mesin[0]->ip_address.'" class="btn btn-info btn-sm"> <i class="mdi mdi-eye"></i></a>
