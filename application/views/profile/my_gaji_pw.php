                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Listing Gaji</h4>
                                        <br><br>

                                        <a href="<?php echo base_url();?>profile/my_tkd" class="btn-list ">
                                           Listing  TKD
                                        </a>
                                        <a href="<?php echo base_url();?>profile/my_gaji" class="btn-list active-btn">
                                           Listing  Gaji
                                        </a>
                                            ...
                                            <table class="table table-sm mb-0 table-bordered">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            <th class="text-end">Pot. BPJS 1%</th>
                                                            <th class="text-end">PPh21</th>
                                                            <th class="text-center">Pot THT 3,25%</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    //print_array($datalist);
                                                      for ($i=0; $i <  count($datalist); $i++) { 
                                                            ...
                                                            $nama_digaji = $datalist[$i]->nama;
                                                            $gaji_pokok = $datalist[$i]->jumlah_gaji;
                                                            $pot_absen = $datalist[$i]->pot_absen;
                                                            $pot_bpjs_1  = $datalist[$i]->pot_bpjs_1;
                                                            $pph21 = $datalist[$i]->pot_pph;
                                                            $pot_tht_325 = $datalist[$i]->pot_tht_325;
                                                            $netto = $datalist[$i]->gaji_setelah_pot_absen;
                                                    
                                                            $ttd_spj = $datalist[$i]->ttd_pegawai;
                                               

                                                            if($ttd_spj==0){
                                                                $btn_ttd = '<span class="badge bg-warning">Belum di TTD</span>';
                                                            }else{
                                                               ...
                                                               <td class="text-end">'.rupiah($pot_absen).'</td>
                                                                <td class="text-end">'.rupiah($pot_bpjs_1).'</td>
                                                                <td class="text-end">'.rupiah($pph21).'</td>
                                                                <td class="text-center">'.rupiah($pot_tht_325).'</td>
                                                          
                                                                <td class="text-end  fw-bold">'.rupiah($netto).'</td>
                                                                 <td class="text-center">'.$btn_ttd.'</td>
                                                                <td  class="text-center"> <a href="'.base_url().'profile/detail_gaji_p3kpw/'.$datalist[$i]->id.'" class="btn btn-primary btn-sm"> Lihat Detail</a></td>
                                                            </tr>';
