                                            ...
                                            <table class="table table-sm mb-0 table-bordered">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            <th class="text-center">Tunj. Suami/istri</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    //print_array($datalist);
                                                      for ($i=0; $i <  count($datalist); $i++) { 
                                                            ...
                                                            $gaji_pokok = $datalist[$i]->gaji_pokok;
                                                            $tunj_suami = $datalist[$i]->tunj_suami;
                                                            $bruto  = $datalist[$i]->bruto;
                                                            $pph21 = $datalist[$i]->pajak;
                                                            $ptkp = $datalist[$i]->ptkp;
                                                            $netto = $datalist[$i]->netto;
                                                            ...
                                                            if($ttd_spj==''){
                                                               ...
                                                               <td class="text-end">'.rupiah($tunj_suami).'</td>
                                                                <td class="text-end">'.rupiah($bruto).'</td>
                                                                <td class="text-end">'.rupiah($pph21).'</td>
                                                                <td class="text-center">'.$ptkp.'</td>
                                                          
                                                                <td class="text-end  fw-bold">'.rupiah($netto).'</td>
                                                                 <td class="text-center">'.$btn_ttd.'</td>
                                                                <td  class="text-center"> <a href="'.base_url().'profile/detail_gaji/'.$datalist[$i]->id.'" class="btn btn-primary btn-sm"> Lihat Detail</a></td>
                                                            </tr>';
