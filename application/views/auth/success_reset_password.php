                    ...
                    <div class="col-xxl-4 col-lg-5">
                     ...
                     <div class="card-body">
                        ...
                        <div class="text-center  m-auto"> 
                            <h4 class="mt-0 text-success"> <i class="mdi mdi-check-circle-outline"></i> Reset Password Berhasil</h4>
                            
                            <p class="text-muted mb-4">Password baru anda sudah berhasil disimpan, Silahkan melakukan login dengan password yang baru.</p>
